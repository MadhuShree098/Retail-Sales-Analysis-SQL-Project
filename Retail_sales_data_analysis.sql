...
-- 6. Finding the total number of transactions (transaction_id) made by each gender in each category:
SELECT category,
       gender,
...
-- 7. Calculating the average sale for each month. Find out best selling month in each year:
SELECT year, month,
    avg_sale
FROM 
(    
...
-- 8. Finding the top 5 customers based on the highest total sales:
SELECT customer_id,
